...
re_ad = osp.join("../result/mag_predict", "EQGraphNet", "EQLSTMNet")
...
if save_txt:
    info_txt_address = osp.join(re_ad, "EQLSTMNet_result.txt")
    info_df_address = osp.join(re_ad, "EQLSTMNet_result.csv")
