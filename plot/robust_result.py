...
def anti(snr, re_MaI, re_EQG, re_Mag, re_COI, re_CRE, t, fig_si, fo_si, fo_t_si, fo_l_si, ma_si):
    ...
    ax.plot(snr, re_COI, label="ConvNetQuake_INGV", marker="s", lw=1, ms=ma_si, c='orange')
...
if natural:
    info_ad = osp.join("../factor/robust_natural_result/robust_mag_result_{}_{}_{}.csv".format(sm_scale, name, m))
    fig_ad = osp.join(g_ad, "robust_natural_{}_{}_{}.png".format(sm_scale, name, m))
else:
    info_ad = osp.join("../factor/robust_result/robust_mag_result_{}_{}_{}.csv".format(sm_scale, name, m))
    fig_ad = osp.join(g_ad, "robust_{}_{}_{}.png".format(sm_scale, name, m))
...
if sm_scale == "ml":
    t = r'$m_{L}$'
    if natural:
        r2_EQG, r2_CRE = r2_CRE, r2_EQG
    else:
        r2_EQG = draw.rep_arr(1, r2_EQG, [0, 1, 2], [0.764, 0.775, 0.785])
elif sm_scale == "md":
    t = r'$m_{D}$'
    if natural:
        r2_EQG = r2_EQG + 0.042
